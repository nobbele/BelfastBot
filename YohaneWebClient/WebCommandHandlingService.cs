...
namespace YohaneWebClient
{
    public class WebCommandHandlingService
    {
        ...
        public (YohaneModuleBase instance, MethodInfo method, CommandAttribute attribute, AliasAttribute alias)[] Commands;
        ...
        public void Initialize()
        {
            ...
            IEnumerable<Type> modules = assembly.GetTypes().Where(type => {
                ...
                if(type.IsAbstract || !type.IsSubclassOf(typeof(YohaneModuleBase)))
                    return false;
            ...
            List<(YohaneModuleBase, MethodInfo, CommandAttribute, AliasAttribute)> commandsList = new List<(YohaneModuleBase, MethodInfo, CommandAttribute, AliasAttribute)>();
            foreach(Type module in modules) {
                YohaneModuleBase o = CreateObject(module) as YohaneModuleBase;
                IEnumerable<(YohaneModuleBase, MethodInfo, CommandAttribute, AliasAttribute)> commands = module
        ...
        {
            (YohaneModuleBase instance, MethodInfo method, CommandAttribute attribute, AliasAttribute alias) command = Commands
            ...
            YohaneCommandContext commandContext = new YohaneCommandContext();
            PropertyInfo contextProp = typeof(YohaneModuleBase).GetProperty("Context").DeclaringType.GetProperty("Context");
